...
const Treat = props => {
  const treatList = [
    { icon: 'icon-baoxianxiang', title: '六险一金', sub: 'COMMERCIAL INSURANCE', content: '入职享受六险一金，并提供餐补、交通补贴以及全勤奖' },
    { icon: 'icon-rili', title: '上班时间', sub: 'COMMERCIAL INSURANCE', content: '早10晚7工作制，完美避开上下班高峰时期' },
    { icon: 'icon-huodong', title: '团建活动', sub: 'COMMERCIAL INSURANCE', content: '进了门，我们就是一家人，一同团建去旅行' },
    { icon: 'icon-yingxiaoguanhuai', title: '节庆关怀', sub: 'COMMERCIAL INSURANCE', content: '传统节假日会有高标准的节日礼金或礼物' },
